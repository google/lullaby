...
#ifndef FLATBUFFERS_GENERATED_COMMON__H_
#define FLATBUFFERS_GENERATED_COMMON__H_
...
inline LayoutFillOrder (&EnumValuesLayoutFillOrder())[8] {
  static LayoutFillOrder values[] = {
    LayoutFillOrder_RightDown,
    LayoutFillOrder_LeftDown,
    LayoutFillOrder_DownRight,
    LayoutFillOrder_DownLeft,
    LayoutFillOrder_RightUp,
    LayoutFillOrder_LeftUp,
    LayoutFillOrder_UpRight,
    LayoutFillOrder_UpLeft
  };
  return values;
}
...
inline LayoutHorizontalAlignment (&EnumValuesLayoutHorizontalAlignment())[3] {
  static LayoutHorizontalAlignment values[] = {
    LayoutHorizontalAlignment_Left,
    LayoutHorizontalAlignment_Center,
    LayoutHorizontalAlignment_Right
  };
  return values;
}
...
inline LayoutVerticalAlignment (&EnumValuesLayoutVerticalAlignment())[3] {
  static LayoutVerticalAlignment values[] = {
    LayoutVerticalAlignment_Top,
    LayoutVerticalAlignment_Center,
    LayoutVerticalAlignment_Bottom
  };
  return values;
}
...
inline DeviceType (&EnumValuesDeviceType())[6] {
  static DeviceType values[] = {
    DeviceType_Hmd,
    DeviceType_Mouse,
    DeviceType_Keyboard,
    DeviceType_Controller,
    DeviceType_Controller2,
    DeviceType_Hand
  };
  return values;
}
...
#endif  // FLATBUFFERS_GENERATED_COMMON__H_
