...
#ifndef REDUX_MODULES_CODECS_DECODE_IMAGE_H_
#define REDUX_MODULES_CODECS_DECODE_IMAGE_H_
...
// Decodes image data that is stored in various formats.
ImageData DecodeImage(const DataContainer& data,
                      const DecodeImageOptions& opts);

}  // namespace redux

#endif  // REDUX_MODULES_CODECS_DECODE_IMAGE_H_
