...
struct ReticleDef FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum {
    ...
    VT_USE_EYE_COLLISION_RAY = 28,
    VT_DEVICE_PREFERENCE = 30
  };
  ...
  bool use_eye_collision_ray() const {
    return GetField<uint8_t>(VT_USE_EYE_COLLISION_RAY, 1) != 0;
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_USE_EYE_COLLISION_RAY) &&
...
struct ReticleDefBuilder {
  ...
  void add_use_eye_collision_ray(bool use_eye_collision_ray) {
    fbb_.AddElement<uint8_t>(ReticleDef::VT_USE_EYE_COLLISION_RAY, static_cast<uint8_t>(use_eye_collision_ray), 1);
  }
...
inline flatbuffers::Offset<ReticleDef> CreateReticleDef(
    ...
    bool use_eye_collision_ray = true,
  ...
  builder_.add_use_eye_collision_ray(use_eye_collision_ray);
