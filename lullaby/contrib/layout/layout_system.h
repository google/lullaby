...
class LayoutSystem : public System {
 public:
  ...
  /// Set the |ignored| state of LayoutElement |element|. If true, this element
  /// will not be considered or modified by LayoutSystem at all.
  void SetElementIgnored(Entity element, bool ignored);
 ...
 private:
  ...
  std::unordered_set<Entity> ignored_layout_elements_;
