...
#ifndef LULLABY_MODULES_LULLSCRIPT_SCRIPT_ENV_H_
#define LULLABY_MODULES_LULLSCRIPT_SCRIPT_ENV_H_
...
class ScriptEnv {
 public:
  ...
  void LetValue(const Symbol& symbol, ScriptValue value);
  ...
  ScriptValue CallWithArray(ScriptValue fn, Span<ScriptValue> args);
  ScriptValue CallWithArray(const Lambda& fn, Span<ScriptValue> args);
  ...
  ScriptValue CallWithMap(ScriptValue callable, const VariantMap& kwargs);
  ScriptValue CallWithMap(const Lambda& fn, const VariantMap& kwargs);
 ...
 private:
  ...
  ScriptValue SetImpl(const ScriptValue& args, ValueType type, bool let = true);
...
#endif  // LULLABY_MODULES_LULLSCRIPT_SCRIPT_ENV_H_
