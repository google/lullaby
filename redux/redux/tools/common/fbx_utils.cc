...
static FbxAxisSystem AxisSystemToFbxAxisSystem(AxisSystem system) {
  ...
  switch (system) {
    case AxisSystem::Unspecified:
      break;
    case AxisSystem::XUp_YFront_ZLeft:
      up = FbxAxisSystem::eXAxis;
      front = FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::XUp_YFront_ZRight:
      up = FbxAxisSystem::eXAxis;
      front = FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::XUp_YBack_ZLeft:
      up = FbxAxisSystem::eXAxis;
      front = FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::XUp_YBack_ZRight:
      up = FbxAxisSystem::eXAxis;
      front = FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::XUp_ZFront_YLeft:
      up = FbxAxisSystem::eXAxis;
      front = -FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::XUp_ZFront_YRight:
      up = FbxAxisSystem::eXAxis;
      front = -FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::XUp_ZBack_YLeft:
      up = FbxAxisSystem::eXAxis;
      front = -FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::XUp_ZBack_YRight:
      up = FbxAxisSystem::eXAxis;
      front = -FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::YUp_XFront_ZLeft:
      up = FbxAxisSystem::eYAxis;
      front = FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::YUp_XFront_ZRight:
      up = FbxAxisSystem::eYAxis;
      front = FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::YUp_XBack_ZLeft:
      up = FbxAxisSystem::eYAxis;
      front = FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::YUp_XBack_ZRight:
      up = FbxAxisSystem::eYAxis;
      front = FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::YUp_ZFront_XLeft:
      up = FbxAxisSystem::eYAxis;
      front = -FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::YUp_ZFront_XRight:
      up = FbxAxisSystem::eYAxis;
      front = -FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::YUp_ZBack_XLeft:
      up = FbxAxisSystem::eYAxis;
      front = -FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::YUp_ZBack_XRight:
      up = FbxAxisSystem::eYAxis;
      front = -FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::ZUp_XFront_YLeft:
      up = FbxAxisSystem::eZAxis;
      front = FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::ZUp_XFront_YRight:
      up = FbxAxisSystem::eZAxis;
      front = FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::ZUp_XBack_YLeft:
      up = FbxAxisSystem::eZAxis;
      front = FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::ZUp_XBack_YRight:
      up = FbxAxisSystem::eZAxis;
      front = FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::ZUp_YFront_XLeft:
      up = FbxAxisSystem::eZAxis;
      front = -FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::ZUp_YFront_XRight:
      up = FbxAxisSystem::eZAxis;
      front = -FbxAxisSystem::eParityEven;
      coord = FbxAxisSystem::eLeftHanded;
      break;
    case AxisSystem::ZUp_YBack_XLeft:
      up = FbxAxisSystem::eZAxis;
      front = -FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eRightHanded;
      break;
    case AxisSystem::ZUp_YBack_XRight:
      up = FbxAxisSystem::eZAxis;
      front = -FbxAxisSystem::eParityOdd;
      coord = FbxAxisSystem::eLeftHanded;
      break;
...
vec3 FbxBaseImporter::Vec3FromFbx(const FbxVector4& v) {
  const FbxDouble* d = v.mData;
  return vec3(static_cast<float>(d[0]), static_cast<float>(d[1]),
              static_cast<float>(d[2]));
}

vec2 FbxBaseImporter::Vec2FromFbx(const FbxVector2& v) {
  const FbxDouble* d = v.mData;
  return vec2(static_cast<float>(d[0]), static_cast<float>(d[1]));
}

quat FbxBaseImporter::QuatFromFbx(const FbxQuaternion& q) {
  const FbxDouble* d = q.mData;
  return quat(static_cast<float>(d[0]), static_cast<float>(d[1]),
              static_cast<float>(d[2]), static_cast<float>(d[3]));
}

mat4 FbxBaseImporter::Mat4FromFbx(const FbxAMatrix& m) {
  const double* d = m;
  // FBX matrices are column-major.
  // clang-format off
  return mat4(static_cast<float>(d[0]), static_cast<float>(d[4]), static_cast<float>(d[8]),  static_cast<float>(d[12]),
              static_cast<float>(d[1]), static_cast<float>(d[5]), static_cast<float>(d[9]),  static_cast<float>(d[13]),
              static_cast<float>(d[2]), static_cast<float>(d[6]), static_cast<float>(d[10]), static_cast<float>(d[14]),
              static_cast<float>(d[3]), static_cast<float>(d[7]), static_cast<float>(d[11]), static_cast<float>(d[15]));
  // clang-format on
}
...
bool FbxBaseImporter::MarkBoneNodesRecursive(
    FbxNode* node, absl::flat_hash_set<FbxNode*>* valid_bones) {
...
void FbxBaseImporter::ApplyScale(float cm_per_unit, float scale_multiplier) {
  if (cm_per_unit <= 1e-7 && scale_multiplier == 1.f) {
    return;
  }

  const FbxSystemUnit import_unit = scene_->GetGlobalSettings().GetSystemUnit();
  const FbxSystemUnit export_unit(
      cm_per_unit <= 1e-7 ? import_unit.GetScaleFactor() : cm_per_unit,
      scale_multiplier);
...
void FbxBaseImporter::ConvertAxis(AxisSystem axis_system) {
  if (axis_system == AxisSystem::Unspecified) {
    return;
  }
