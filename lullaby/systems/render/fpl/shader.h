...
#ifndef LULLABY_SYSTEMS_RENDER_FPL_SHADER_H_
#define LULLABY_SYSTEMS_RENDER_FPL_SHADER_H_
...
class Shader {
 public:
  ...
  // Returns the implementation shader.
  const ShaderImplPtr& Impl() const;
...
#endif  // LULLABY_SYSTEMS_RENDER_FPL_SHADER_H_
