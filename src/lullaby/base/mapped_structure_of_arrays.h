...
#ifndef LULLABY_BASE_MAPPED_STRUCTURE_OF_ARRAYS_H_
#define LULLABY_BASE_MAPPED_STRUCTURE_OF_ARRAYS_H_

#include <unordered_map>

#include "lullaby/base/structure_of_arrays.h"
...
#endif  // LULLABY_BASE_MAPPED_STRUCTURE_OF_ARRAYS_H_
