...
#ifndef FLATBUFFERS_GENERATED_VARIANTDEF__H_
#define FLATBUFFERS_GENERATED_VARIANTDEF__H_
...
struct VariantArrayDefImpl;

struct VariantArrayDef;

struct VariantMapDef;
...
struct KeyVariantPairDef FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint32_t hash_key() const {
    return GetField<uint32_t>(VT_HASH_KEY, 0);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(key()) &&
           VerifyField<uint32_t>(verifier, VT_HASH_KEY) &&
...
struct KeyVariantPairDefBuilder {
  ...
  void add_hash_key(uint32_t hash_key) {
    fbb_.AddElement<uint32_t>(KeyVariantPairDef::VT_HASH_KEY, hash_key, 0);
  }
...
struct VariantArrayDefImpl FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "lull.VariantArrayDefImpl";
  }
  enum {
    VT_VALUE_TYPE = 4,
    VT_VALUE = 6
...
template<> inline const DataBool *VariantArrayDefImpl::value_as<DataBool>() const {
  return value_as_DataBool();
}

template<> inline const DataInt *VariantArrayDefImpl::value_as<DataInt>() const {
  return value_as_DataInt();
}

template<> inline const DataFloat *VariantArrayDefImpl::value_as<DataFloat>() const {
  return value_as_DataFloat();
}

template<> inline const DataString *VariantArrayDefImpl::value_as<DataString>() const {
  return value_as_DataString();
}

template<> inline const DataHashValue *VariantArrayDefImpl::value_as<DataHashValue>() const {
  return value_as_DataHashValue();
}

template<> inline const DataVec2 *VariantArrayDefImpl::value_as<DataVec2>() const {
  return value_as_DataVec2();
}

template<> inline const DataVec3 *VariantArrayDefImpl::value_as<DataVec3>() const {
  return value_as_DataVec3();
}

template<> inline const DataVec4 *VariantArrayDefImpl::value_as<DataVec4>() const {
  return value_as_DataVec4();
}

template<> inline const DataQuat *VariantArrayDefImpl::value_as<DataQuat>() const {
  return value_as_DataQuat();
}

struct VariantArrayDefImplBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_value_type(VariantDef value_type) {
    fbb_.AddElement<uint8_t>(VariantArrayDefImpl::VT_VALUE_TYPE, static_cast<uint8_t>(value_type), 0);
  }
  void add_value(flatbuffers::Offset<void> value) {
...
inline flatbuffers::Offset<VariantArrayDefImpl> CreateVariantArrayDefImpl(
    flatbuffers::FlatBufferBuilder &_fbb,
    VariantDef value_type = VariantDef_NONE,
    flatbuffers::Offset<void> value = 0) {
  VariantArrayDefImplBuilder builder_(_fbb);
  builder_.add_value(value);
  builder_.add_value_type(value_type);
  return builder_.Finish();
}
...
struct VariantArrayDef FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "lull.VariantArrayDef";
  }
  enum {
    VT_VALUES = 4
  };
  const flatbuffers::Vector<flatbuffers::Offset<VariantArrayDefImpl>> *values() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<VariantArrayDefImpl>> *>(VT_VALUES);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline flatbuffers::Offset<VariantArrayDef> CreateVariantArrayDef(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<VariantArrayDefImpl>>> values = 0) {
  VariantArrayDefBuilder builder_(_fbb);
  builder_.add_values(values);
  return builder_.Finish();
}

inline flatbuffers::Offset<VariantArrayDef> CreateVariantArrayDefDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<VariantArrayDefImpl>> *values = nullptr) {
  return lull::CreateVariantArrayDef(
      _fbb,
      values ? _fbb.CreateVector<flatbuffers::Offset<VariantArrayDefImpl>>(*values) : 0);
}

/// The flatbuffer equivalent for lull::VariantMap.
struct VariantMapDef FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "lull.VariantMapDef";
  }
  enum {
    VT_VALUES = 4
  };
...
inline flatbuffers::Offset<VariantMapDef> CreateVariantMapDef(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<KeyVariantPairDef>>> values = 0) {
  VariantMapDefBuilder builder_(_fbb);
  builder_.add_values(values);
  return builder_.Finish();
}

inline flatbuffers::Offset<VariantMapDef> CreateVariantMapDefDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<KeyVariantPairDef>> *values = nullptr) {
  return lull::CreateVariantMapDef(
      _fbb,
...
#endif  // FLATBUFFERS_GENERATED_VARIANTDEF__H_
