...
//
// Note: Currently the text system is a component of RenderSystem, and is not
// expected to be used directly.  After apps are migrated to use TextSystem
// directly, this will be made independent (b/33705809).
