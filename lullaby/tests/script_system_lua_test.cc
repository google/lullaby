...
class ScriptSystemTest : public ::testing::Test {
 protected:
  ScriptSystemTest() {
    ...
    script_engine_->CreateEngine<script::lua::Engine>();
...
TEST_F(ScriptSystemTest, ScriptOnEventDef) {
  ...
  script_on_event.script.language = Language_Lua5_2;
  Blueprint blueprint;
...
TEST_F(ScriptSystemTest, ScriptEveryFrameDef) {
  ...
  script_every_frame.script.language = Language_Lua5_2;
  Blueprint blueprint;
  blueprint.Write(&transform);
...
TEST_F(ScriptSystemTest, ScriptOnCreateDef) {
  ...
  script_on_create.script.language = Language_Lua5_2;
  Blueprint blueprint;
  blueprint.Write(&transform);
...
TEST_F(ScriptSystemTest, ScriptOnPostCreateInitDef) {
  ...
  script_on_post_create_init.script.language = Language_Lua5_2;
  Blueprint blueprint;
  blueprint.Write(&transform);
  blueprint.Write(&script_on_create);
...
TEST_F(ScriptSystemTest, ScriptOnDestroyDef) {
  ...
  script_on_destroy.script.language = Language_Lua5_2;
  Blueprint blueprint;
  blueprint.Write(&transform);
