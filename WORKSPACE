...
new_http_archive(
  name = "fplbase",
  urls = ["https://github.com/google/fplbase/archive/d08ef132eaf8.tar.gz"],
  build_file = "third_party/BUILD.fplbase",
  strip_prefix = "fplbase-d08ef132eaf879d4d3688ababd61f03b763f60c9",
)
...
new_http_archive(
   ...
   build_file = "third_party/BUILD.libjpeg_turbo",
...
new_http_archive(
  name = "mathfu",
  urls = ["https://github.com/google/mathfu/archive/183949afc886.tar.gz"],
  build_file = "third_party/BUILD.mathfu",
  strip_prefix = "mathfu-183949afc886d1f6bd997dca1838b6b9821cf22d",
)

new_http_archive(
  name = "motive",
  urls = ["https://github.com/google/motive/archive/23bf38c4efde.tar.gz"],
  build_file = "third_party/BUILD.motive",
  strip_prefix = "motive-23bf38c4efde19b020a6600b4ddf6a340a95c5a0",
)
