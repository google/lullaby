...
#ifndef LULLABY_MODULES_RETICLE_RETICLE_PROVIDER_H_
#define LULLABY_MODULES_RETICLE_RETICLE_PROVIDER_H_
...
class ReticleProvider {
 public:
  ...
  virtual Ray GetCollisionRay() const = 0;
...
#endif  // LULLABY_MODULES_RETICLE_RETICLE_PROVIDER_H_
