...
#ifndef REDUX_MODULES_AUDIO_WAV_READER_H_
#define REDUX_MODULES_AUDIO_WAV_READER_H_
...
// Stream decodes a WAV file or memory block in WAV format.
class WavReader : public AudioReader {
 public:
  explicit WavReader(DataReader reader);
  ...
  bool IsAtEndOfStream() const override { return reader_.IsAtEndOfStream(); }
  ...
  // Checks the data reader to see if it contains a .wav header.
...
#endif  // REDUX_MODULES_AUDIO_WAV_READER_H_
