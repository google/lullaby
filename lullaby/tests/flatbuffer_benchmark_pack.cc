...
#include "lullaby/tools/testdata/flatc_ref_generated.h"
...
void Flatbuffer_Pack_Benchmark(::benchmark::State& state) {
  ComplexT obj;
  obj.name = "hello";
  obj.basic.reset(new BasicsT());
  obj.basic->b = true;
  obj.basic->u8 = 1;
  obj.basic->i8 = 2;
  obj.basic->u16 = 3;
  ...
  obj.basic->str = "world";
  obj.basics.resize(2);
  obj.basics[0].reset(new BasicsT());
  obj.basics[1].reset(new BasicsT());
  obj.basics[0]->b = true;
  obj.basics[0]->u8 = 1;
  obj.basics[0]->i8 = 2;
  obj.basics[0]->u16 = 3;
  ...
  obj.out.reset(new OuterFixed());
  obj.out->mutable_mid().mutable_in().mutate_a(1);
  obj.out->mutable_mid().mutable_in().mutate_b(2);
  obj.out->mutable_mid().mutable_in().mutate_c(3);
  obj.out->mutable_mid().mutate_t(4);
  obj.out->mutable_mid().mutate_u(5);
  obj.out->mutable_mid().mutate_v(6);
  obj.out->mutate_x(7.7f);
  obj.out->mutate_y(8.8f);
  obj.out->mutate_z(9.9f);
  obj.numbers = {1, 2, 3};
  obj.names = {"a", "bc", "def"};
  obj.outs.resize(2);
  obj.outs[0].mutable_mid().mutable_in().mutate_a(1);
  obj.outs[0].mutable_mid().mutable_in().mutate_b(2);
  obj.outs[0].mutable_mid().mutable_in().mutate_c(3);
  obj.outs[0].mutable_mid().mutate_t(4);
  obj.outs[0].mutable_mid().mutate_u(5);
  obj.outs[0].mutable_mid().mutate_v(6);
  obj.outs[0].mutate_x(7.7f);
  obj.outs[0].mutate_y(8.8f);
  obj.outs[0].mutate_z(9.9f);
  obj.outs[1].mutable_mid().mutable_in().mutate_a(10);
  obj.outs[1].mutable_mid().mutable_in().mutate_b(20);
  obj.outs[1].mutable_mid().mutable_in().mutate_c(30);
  obj.outs[1].mutable_mid().mutate_t(40);
  obj.outs[1].mutable_mid().mutate_u(50);
  obj.outs[1].mutable_mid().mutate_v(60);
  obj.outs[1].mutate_x(70.07f);
  obj.outs[1].mutate_y(80.08f);
  obj.outs[1].mutate_z(90.09f);
  obj.vec2.reset(new Vec2(1.f, 2.f));
  obj.vec3.reset(new Vec3(3.f, 4.f, 5.f));
  obj.vec4.reset(new Vec4(6.f, 7.f, 8.f, 9.f));
  obj.quat.reset(new Quat(10.f, 11.f, 12.f, 13.f));
  obj.vec2s = {
      {1.f, 2.f}, {10.f, 20.f},
  };
  obj.vec3s = {
  ...
  for (auto _ : state) {
    ...
    auto c = Complex::Pack(fbb, &obj);
    (void)c;
  }
}

void Flatbuffer_UnPack_Benchmark(::benchmark::State& state) {
  flatbuffers::FlatBufferBuilder fbb;
...
BENCHMARK(lull::Flatbuffer_Pack_Benchmark);
BENCHMARK(lull::Flatbuffer_UnPack_Benchmark);
