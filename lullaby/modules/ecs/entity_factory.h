...
// autogenerated tables from the generate_entity_schema BUILD rule.
//
...
class EntityFactory {
 public:
  ...
  // to the generate_entity_schema rule, and call this in the form:
  //
...
void EntityFactory::InitializeLoader(GetEntityDefFn get_entity_def,
                                     FlatbufferConverter* converter) {
  converter->load =
      [this, get_entity_def, converter](const void* data,
