...
#include "lullaby/contrib/map_events/map_events_system.h"
...
MapEventsSystem::MapEventsSystem(Registry* registry)
  ...
  RegisterDef<MapEventsToChildrenDefT>(this);
  RegisterDef<MapEventsToParentDefT>(this);
  RegisterDef<MapEventsToSiblingsDefT>(this);
  RegisterDef<MapEventsToGroupDefT>(this);
  RegisterDef<MapEventsToDescendantsDefT>(this);
