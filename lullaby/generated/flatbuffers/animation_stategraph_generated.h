...
enum AnimationSelectorDef {
  ...
  AnimationSelectorDef_MAX = AnimationSelectorDef_FirstAnimationSelectorDef
};

inline AnimationSelectorDef (&EnumValuesAnimationSelectorDef())[2] {
...
struct FirstAnimationSelectorDefBuilder {
  ...
  FirstAnimationSelectorDefBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
struct AnimationTransitionDefBuilder {
  ...
  AnimationTransitionDefBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct AnimationStateDefBuilder {
  ...
  AnimationStateDefBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct AnimationStategraphDefBuilder {
  ...
  AnimationStategraphDefBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
