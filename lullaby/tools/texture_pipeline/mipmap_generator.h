...
#ifndef LULLABY_TOOLS_TEXTURE_PIPELINE_MIPMAP_GENERATOR_H_
#define LULLABY_TOOLS_TEXTURE_PIPELINE_MIPMAP_GENERATOR_H_
...
#endif  // LULLABY_TOOLS_TEXTURE_PIPELINE_MIPMAP_GENERATOR_H_
