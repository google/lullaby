...
#ifndef FLATBUFFERS_GENERATED_TEXTDEF__H_
#define FLATBUFFERS_GENERATED_TEXTDEF__H_
...
inline TextHtmlMode (&EnumValuesTextHtmlMode())[3] {
  static TextHtmlMode values[] = {
    TextHtmlMode_Ignore,
    TextHtmlMode_RemoveTags,
...
inline TextWrapMode (&EnumValuesTextWrapMode())[3] {
  static TextWrapMode values[] = {
    TextWrapMode_None,
    TextWrapMode_BetweenWords,
    TextWrapMode_Hyphenate
  };
  return values;
}
...
inline TextDirection (&EnumValuesTextDirection())[3] {
  static TextDirection values[] = {
    TextDirection_UseSystemSetting,
...
#endif  // FLATBUFFERS_GENERATED_TEXTDEF__H_
